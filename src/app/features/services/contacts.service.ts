...
export class ContactsService {
  ...
  getAllSpecialities(): Observable<Array<Speciality>> {
    return this.globalService.call(RequestType.GET, this.globalService.url.spaciality);
  }
  deleteMultiple(ids){
    return this.globalService.call(RequestType.POST, this.globalService.url.contact_pro_delete, ids);
  }
